...
public class Produto implements Serializable{
	...
	/*
	 * Em uma relação muitos para muitos(n*n) é preciso criar uma tabela intermediaria que relacione as duas entidades
	 * @JoinTable(name = "PRODUTO_CATEGORIA" --> cria essa tabela intermediaria e seu nome
